...
test('TC00000035 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
    ...
    // await t.selectText(ModalDate) //ModalDate 기존 텍스트를 선택
    //     .pressKey('delete');    //선택한 텍스트 삭제
    await t.typeText(ModalDate, '2024-02-21').wait(3000);   //새로운 텍스트 입력
    ...
    await t.click(EditTodo).wait(2000); //수정 버튼 클릭
    await t.expect(ModalTitle.value).eql('Test title'); //글자비교
    await t.expect(ModalContent.value).eql('Test content'); //내용란 그대로인지
    await t.expect(ModalDate.value).eql('2024-02-21');
...
test('TC00000037 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
    ...
    await t.selectText(ModalTitle) //ModalTitle 기존 텍스트를 선택
        .pressKey('delete');    //선택한 텍스트 삭제
    ...
    await t.click(EditTodo).wait(2000); //수정 버튼 클릭
    await t.expect(ModalTitle.value).eql('Test Change title'); //글자비교
    await t.expect(ModalContent.value).eql('Test content'); //내용란 그대로인지
    await t.expect(ModalDate.value).eql('2024-02-21');
...
test('TC00000039 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
    ...
    await t.selectText(ModalContent) //ModalContent 기존 텍스트를 선택
        .pressKey('delete');    //선택한 텍스트 삭제
    await t.typeText(ModalContent, 'Test Change content').wait(3000);
    await t.typeText(ModalDate, '2024-02-21').wait(3000);   //새로운 텍스트 입력
    ...
    await t.click(EditTodo).wait(2000); //수정 버튼 클릭
    await t.expect(ModalTitle.value).eql('Test title'); //글자비교
    await t.expect(ModalContent.value).eql('Test Change content');
    await t.expect(ModalDate.value).eql('2024-02-21');
...
test('TC00000040 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
    ...
    await t.selectText(ModalTitle) //ModalContent 기존 텍스트를 선택
        .pressKey('delete');
    await t.selectText(ModalContent) //ModalContent 기존 텍스트를 선택
        .pressKey('delete');    //선택한 텍스트 삭제
    await t.typeText(ModalTitle, 'Test Change title');
    await t.typeText(ModalContent, 'Test Change content');
    await t.typeText(ModalDate, '2024-02-21').wait(3000);   //새로운 텍스트 입력
...
test('TC00000042 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
...
test('TC00000044 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
...
test('TC00000046 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
...
test('TC00000047 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
...
test('TC00000049 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
...
test('TC00000051 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
...
test('TC00000053 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
...
test('TC00000054 Edit test', async t=> {
    const CreateTodo = {
        title: 'Test title',
        content: 'Test content',
        date: '2024-02-20',
